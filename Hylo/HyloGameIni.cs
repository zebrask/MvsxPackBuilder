...
using System.IO;
using System.Text;
class GFG : IComparer<List<Hylo.GameEntry>>
{
    public int Compare(List<Hylo.GameEntry> x, List<Hylo.GameEntry> y)
    {
        /*if (x == null || y == null)
        {
            return 0;
...
namespace MvsxPackBuilder
{
    public class HyloGameIniParser
    {
        ...
        public static void Serialize(List<Hylo.GameEntry> GameEntries, string filename)
        {
            ...
            {
                writer.WriteLine("# auto generated by MvsxPackBuilder, do not edit this !");
                writer.WriteLine("");
                //GameEntries.Sort()

        // "sortAlpha" is the object
        GFG sortAlpha = new GFG();
          
        Console.WriteLine("\nSort a range with comparer:");
          
        // sort the list within a 
        GameEntries.Sort(sortAlpha);
